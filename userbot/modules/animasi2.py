...
@register(outgoing=True, pattern='^.lopuca(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    ...
    await typew.edit("`Aku Sayang P`")
    await typew.edit("`Aku Sayang Pu`")
    await typew.edit("`Aku Sayang Putri`")
    await typew.edit("`Aku Sayang Putri A`")
    await typew.edit("`Aku Sayang Putri Ap`")
    await typew.edit("`Aku Sayang Putri Apr`")
    await typew.edit("`Aku Sayang Putri Apri`")
    await typew.edit("`Aku Sayang Putri April`")
    await typew.edit("`Aku Sayang Putri Aprili`")
    await typew.edit("`Aku Sayang Putri Aprilia`")
    await typew.edit("`Aku Sayang Putri Aprilian`")
    await typew.edit("`Aku Sayang Putri Apriliani`")
    sleep(1)
...
async def typewriter(typew):
    ...
    await typew.edit("👻")
    sleep(2)
    await typew.edit("**⚜️•ᴄʜєᴧ✞̸.​ɛxɛ✰̶✰̶⚜️**👻")
