...
async def typewriter(typew):
    ...
    sleep(1)
    await typew.edit("`CACA MAU GA SI?`")
    sleep(1)
    ...
    sleep(1)
    await typew.edit("`Putri Apriliani`")
    sleep(1)
...
async def _(event):
    ...
    if input_str == "cinta":
        ...
        animation_chars = [
            ...
            "`Menemukan server Putri Apriliani`",
            "`Menghubungkan server Putri `",
            "`Mengirim Cintaku.. 0%\n▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku.. 4%\n█▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku.. 8%\n██▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            "`Mengirim Cintaku.. 20%\n█████▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒▒ `",
            ...
            "`Reported `",
            "``Cinta gw sepenuhnya buat Sasa,Gw Cintai CACA,Gw janji ga bakal niggalin Caca tanpa alasan jelas `",
            f" ILY SEKEBON CA💞`"]
